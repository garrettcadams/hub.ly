	...
	$fields = array(
		...
		'header_text_color'                       => array(
			...
			'js_vars'         => array(
				...
				array(
					'element'  => '.header-layout-1 .site-header .product-extra-search .hot-words li a,.header-layout-1 .site-header .primary-nav > ul > li > a, .header-layout-1 .site-header .products-cats-menu .cats-menu-title .text, .header-layout-1 .site-header .products-cats-menu .cats-menu-title',
					'property' => 'color',
				),
				array(
					'element'  => '.header-layout-5 .site-header .product-extra-search .hot-words li a, .header-layout-5 .topbar a, .header-layout-5 .topbar, .header-layout-5 .site-header .primary-nav>ul>li>a, .header-layout-5 .topbar .mf-currency-widget .current:after',
					'property' => 'color',
				),
			),
			'active_callback' => array(
		...
		'header_hover_color'                      => array(
			...
			'js_vars'         => array(
				...
				array(
					'element'  => '.header-layout-5 .site-header .product-extra-search .hot-words li a:hover, .header-layout-5 .site-header .primary-nav > ul > li.current-menu-parent > a, .header-layout-5 .site-header .primary-nav > ul > li.current-menu-item > a, .header-layout-5 .site-header .primary-nav > ul > li.current-menu-ancestor > a',
					'property' => 'color',
				),
			),
			'active_callback' => array(
